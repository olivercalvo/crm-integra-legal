...
/**
 * Error boundary para /finanzas/gastos-bufete*. Captura errores no manejados
 * en server components o effects.
 */
export default function Error({
  ...
  useEffect(() => {
    console.error("[finanzas/gastos-bufete] error boundary:", error);
  }, [error]);
