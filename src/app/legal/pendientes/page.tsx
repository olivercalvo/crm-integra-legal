...
import { AsistentePendientes } from "@/components/dashboards/asistente-pendientes";

export default async function MisPendientesPage() {
  const ctx = await getAuthenticatedContext();
  // Asistente: "Mis Pendientes" son sus tareas asignadas (tabla `tasks`),
  // agrupadas por caso. Para abogada/admin son personal_todos.
  if (ctx.userRole === "asistente") {
    return <AsistentePendientes />;
  }
