...
const navItems: NavItem[] = [
  ...
  { label: "Casos", href: "/abogada/expedientes", icon: <FolderOpen size={20} />, roles: ["admin", "abogada"] },
  { label: "Gastos", href: "/abogada/gastos", icon: <DollarSign size={20} />, roles: ["admin", "abogada"] },
  { label: "Tareas", href: "/abogada/tareas", icon: <ListTodo size={20} />, roles: ["admin", "abogada"] },
